                    ...
                    <div class="white-box">
                        <div class="form-horizontal form-material">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" readonly value="${tasksModel.jobsModel.name}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" readonly value="${tasksModel.name}"
                                           class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" readonly value="${tasksModel.startDate}"
                                           class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" readonly value="${tasksModel.endDate}"
                                           class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control form-control-line" id="input-status">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button class="btn btn-success"
                                            onclick="updateTaskStatus(${tasksModel.id})">Cập nhật
                                    </button>
                                    <a href="/crm/profile?id=${sessionScope.usersModel.id}"
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    window.location.href = "/crm/profile?id=${sessionScope.usersModel.id}";
                } else {
