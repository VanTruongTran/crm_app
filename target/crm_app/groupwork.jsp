                    ...
                    <div class="white-box">
                        <div class="table-responsive">
                            <table class="table" id="example">
                                ...
                                <tbody>
                                <c:forEach var="jobsModel" items="${jobsModelList}" varStatus="sst">
                                    <tr>
                                        <td>${sst.index+1}</td>
                                        <td>${jobsModel.name}</td>
                                        <td>${jobsModel.startDate}</td>
                                        <td>${jobsModel.endDate}</td>
                                        <td>
...
<script>
    function deleteJob(This, id) {
        if (confirm("ARE YOU SURE")) {
            $.ajax({
                    url: "/crm/api/groupwork-delete",
                    type: "post",
                    data: {
                        id: id
                    },
