...
public class TasksRepository {
    ...
    public List<TasksModel> getTasksListWhereUserId(int userId) {
        final String QUERY = "SELECT * FROM tasks t WHERE t.user_id = ?";
        List<TasksModel> tasksModelList = new ArrayList<TasksModel>();
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        ...
        try {
            ...
            System.out.println("Found error in 'getTasksListWhereUserId', " + ex.getMessage());
            ex.printStackTrace();
        }
        return tasksModelList;
    }
    ...
    public List<TasksModel> getTasksListWhereJobId(int jobId) {
        final String QUERY = "SELECT * FROM tasks t WHERE t.job_id = ?";
        List<TasksModel> tasksModelList = new ArrayList<TasksModel>();
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        ...
        try {
            ...
            System.out.println("Found error in 'getTasksListWhereJobId', " + ex.getMessage());
            ex.printStackTrace();
        }
        return tasksModelList;
    }
