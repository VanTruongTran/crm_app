                    ...
                    <div class="white-box">
                        <div class="table-responsive">
                            <table class="table" id="example">
                                ...
                                <tbody>
                                <c:forEach var="rolesModel" items="${rolesModelList}" varStatus="stt">
                                    <tr>
                                        <td>${stt.index + 1}</td>
                                        <td>${rolesModel.name}</td>
                                        <td>${rolesModel.description}</td>
                                        <td>
                                            <a href="/crm/role-update?id=${rolesModel.id}"
                                               class="btn btn-sm btn-primary">Sửa</a>
                                            <a class="btn btn-sm btn-danger"
                                               onclick="deleteRole(this,${rolesModel.id})">Xóa</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<script>
    function deleteRole(This, id) {
        if (confirm("ARE YOU SURE")) {
            $.ajax({
                url: "/crm/api/role-delete",
                type: "post",
                data: {
                    id: id
                },
