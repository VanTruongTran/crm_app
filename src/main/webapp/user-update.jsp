                    ...
                    <div class="white-box">
                        <div class="form-horizontal form-material">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input id="input-fullname" type="text"
                                           value="${usersModel.fullname}" placeholder="Fullname"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input id="input-email" type="email"
                                           value="${usersModel.email}" placeholder="Email"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input id="input-avatar" type="text"
                                           value="${usersModel.avatar}" placeholder="Picture link"
                                           class="form-control form-control-line"></div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button class="btn btn-success" onclick="updateUser(${usersModel.id})">Cập nhật
                                    </button>
