                    ...
                    <div class="white-box">
                        <div class="form-horizontal form-material">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input id="input-start-date" type="text" value="${jobsModel.startDate}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input id="input-end-date" type="text" value="${jobsModel.endDate}"
                                           placeholder="dd/MM/yyyy"
                                           class="form-control form-control-line"></div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button class="btn btn-success" onclick="updateJob(${jobsModel.id})">Cập nhật
                                    </button>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        window.location.href = "/crm/groupwork";
                    } else {
                        alert("UNSUCCESSFUL");
                    }
                },
